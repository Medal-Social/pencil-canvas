...
function parseNode(raw: unknown): PenNode {
  ...
  const props = [
    'name', 'x', 'y', 'width', 'height', 'fill', 'stroke', 'opacity',
    'cornerRadius', 'layout', 'gap', 'padding', 'justifyContent', 'alignItems',
    'content', 'fontFamily', 'fontSize', 'fontWeight', 'letterSpacing',
    'textAlign', 'lineHeight', 'textGrowth',
    'iconFontFamily', 'iconFontName', 'iconCodepoint',
    'geometry', 'viewBox', 'clip', 'effect',
    'src', 'points', 'fontStyle', 'refId',
  ] as const;
